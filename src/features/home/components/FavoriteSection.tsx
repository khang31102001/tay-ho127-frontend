...
import { ProductCard, type UiProduct } from "@/features/menu";
...
type FavoriteSectionProps = {
  /** Danh sách món "yêu thích" lấy từ Catalog (features/menu, fetchFeaturedMenu). */
  items: UiProduct[];
};
...
export function FavoriteSection({ items }: FavoriteSectionProps) {
  /**
   ...
   */
  const favorites = items.slice(0, 6);
